...
SCREEN_SIZES = [
    ...
    (r"(?:what|which).*gas.*(?:most.*abundant.*air|most.*air)", "nitrogen"),
...
# ── Objects / function ──
    ...
    (r"what.*(?:element|symbol).*(?:gold|Au)", "au"),
    (r"what.*(?:element|symbol).*(?:silver|Ag)", "ag"),
    (r"what.*(?:element|symbol).*(?:iron|Fe)", "fe"),
    (r"what.*(?:element|symbol).*(?:oxygen|O)", "o"),
    (r"what.*(?:element|symbol).*(?:carbon|C)", "c"),
    (r"what.*(?:element|symbol).*(?:hydrogen|H)", "h"),
    (r"what.*(?:element|symbol).*(?:helium|He)", "he"),
    (r"what.*(?:element|symbol).*(?:sodium|Na)", "na"),
    (r"what.*(?:element|symbol).*(?:potassium|K)", "k"),
    (r"what.*(?:element|symbol).*(?:calcium|Ca)", "ca"),
    (r"what.*(?:element|symbol).*(?:lead|Pb)", "pb"),
    (r"what.*(?:element|symbol).*(?:mercury|Hg)", "hg"),
    (r"what.*(?:element|symbol).*(?:copper|Cu)", "cu"),
    (r"what.*(?:element|symbol).*(?:zinc|Zn)", "zn"),
    (r"what.*(?:element|symbol).*(?:tin|Sn)", "sn"),
    (r"what.*(?:element|symbol).*(?:aluminum|Al)", "al"),
    ...
    (r"what (?:waterfall|cascade).*tallest", "angel falls"),
